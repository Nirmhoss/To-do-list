"""
Todo management routes for the Todo API.

This module defines endpoints for creating, reading, updating, and deleting todo items,
with appropriate authentication and user authorization.
"""
